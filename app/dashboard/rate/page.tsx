...
function RateContent() {
  ...
  useEffect(() => {
    ...
    const fetchRating = async () => {
      try {
        const res = await fetch(`/api/client/rate?jobId=${jobId}`);
        if (res.status === 401) {
  ...
  const handleSubmit = async () => {
    if (!jobId || selectedRating === 0 || submitting) return;
    setSubmitting(true);
    setError('');
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ color: '#999', fontSize: '0.9rem', lineHeight: 1.6 }}>
              This rating link appears to be invalid or incomplete. Please use the link from your audit email.
            </p>
          </div>
        </div>
      </div>
            ...
            {isPositive ? (
              <div style={{ marginTop: '2rem' }}>
                ...
                <div style={{
                  ...
                  <a
                    href="https://trustpilot.com/review/presenzia.ai"
                    target="_blank"
