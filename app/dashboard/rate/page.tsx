            ...
            {isPositive ? (
              <div style={{ marginTop: '2rem' }}>
                <p style={{
                  ...
                  We&apos;re a small, independent team and reviews genuinely make a huge difference to us — they help other firms find us and keep us going. If you have a moment, we&apos;d really appreciate it.
                </p>
                ...
                <div style={{
                  ...
                  {/* Trustpilot */}
                  <a
                    href="https://www.trustpilot.com/review/presenzia.ai"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
                  ...
                  {/* LinkedIn */}
                  <a
                    href="https://www.linkedin.com/company/presenzia-ai"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
